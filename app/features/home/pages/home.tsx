...
import { TypographyBase, TypographyH1 } from '@shared/components/typography'

import { SellerCard, BackgroundVideo } from '@features/home/components'
...
export function Home() {
  return (
    <Layout>
      ...
      <Section className="flex flex-col items-center text-center lg:text-start lg:block pt-10">
      ...
      <Section className="flex flex-col items-center text-center lg:text-start lg:block">
